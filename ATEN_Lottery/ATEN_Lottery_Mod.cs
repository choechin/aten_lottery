...
namespace ATEN_Lottery
{
    public partial class ATEN_Lottery_Mod : Form
    {
        ...
        private void bkw_gif_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            Thread.Sleep(GIF_WAIT_MILLISECONDS);
            currentWinner = lotteryProcess.GetOneWinner(lotteryProcess.AwardList[0]);
        }

        private void bkw_gif_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            pbx_Star.Visible = false;
            FillCurrentWinner();
