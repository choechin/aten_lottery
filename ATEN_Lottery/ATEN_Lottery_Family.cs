...
{
    public partial class ATEN_Lottery_Family : Form
    {
        ...
        public ATEN_Lottery_Family()
        {
            ...
            lblByPass.BackColor = System.Drawing.Color.Transparent;
            lblNextAward.BackColor = System.Drawing.Color.Transparent;
        }
        ...
        private const string SCROLL1 = "pic\\nscroll_area_01.png";
        private const string SCROLL2 = "pic\\nscroll_area_02.png";
        private const string SCROLL3 = "pic\\nscroll_area_03.png";
        ...
        private void ATEN_Lottery_Family_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.NumPad2 || e.KeyCode == Keys.D2)
            {
                lottery_go();
            }
        }

        private void lottery_go()
        {
            try
            {
                if (!CheckAwardEnd())
